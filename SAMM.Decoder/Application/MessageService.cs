...
using SAMM.Decoder.Infraestructure;

namespace SAMM.Decoder.Application
{
    internal class MessageService
    {
        public static bool MsgFormatting(string message)
        {
            ...
            {
                string connectionString = "Server=localhost;Database=samm;Uid=root;Pwd=;";
                Infraestructure.DatabaseConnection db = new(connectionString);
        ...
        internal static (bool, double, double, string, string, string, int, int, float) HeaderAnalizer(string message)
        {
            ...
            bool valid = true;
            var Time = Domain.Decode.ProcessTime(thirdGroup);
